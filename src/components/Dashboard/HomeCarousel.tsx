...
import Casino1 from '../../images/cards/casino1.jpeg';
function HomeCarousel() {
  ...
  return (
    ...
    <div className="relative overflow-hidden">
      ...
      <div
        ref={carousel}
        className="carousel-container relative flex gap-1.5 overflow-hidden scroll-smooth snap-x snap-mandatory touch-pan-x z-0"
      >
        {carouselImages.map((resource, index) => {
          return (
            <div
              key={index}
              className="carousel-item text-center relative md:w-54 md:h-54 w-26 h-26 snap-start"
            >
              <a
                href={resource.link}
